...
lint-py:  ## lint python with ruff
	python -m ruff check pydantic_cron
	python -m ruff format --check pydantic_cron
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix pydantic_cron
	python -m ruff format pydantic_cron
...
test:  ## run python tests
	python -m pytest -v pydantic_cron/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v pydantic_cron/tests --cov=pydantic_cron --cov-report term-missing --cov-report xml
